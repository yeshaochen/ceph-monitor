#!/usr/bin/env python
#
# Using ceph command line tools to make wrapper python tool,
# to get ceph's common info and performance info in json style.
#
# Author: yeshaochen
# Date: 2014-4-18
#

import sys, time, commands, json, string
